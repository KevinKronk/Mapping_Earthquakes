...
// Add control to the map for users to change which layers are visible
L.control.layers(baseMaps, overlays).addTo(map);

// Retrieve earthquake GeoJSON data
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
    console.log(data);
    // function returns style of each earthquake marker 
    ...
    // Determines the color of the circle based on magnitude of the earthquake
    ...
    // Function to determine radius of earthquake marker based on its magnitude
...
legend.onAdd = function() {
    ...
    // Looping through our intervals to generate a label with color for each interval
